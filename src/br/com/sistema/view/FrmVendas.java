...
public class FrmVendas extends javax.swing.JFrame {
    ...
    private void initComponents() {
     ...
     public void percorreListaVenda(){
         int totalItens;
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
        ...
        //seleciona a quantidade pedida pelo usuário
        qtd = Integer.parseInt(txtqtd.getText());
        
        //pega o id digitado
        idProduto = Integer.parseInt(txtcodigo.getText());
        
        // total de produtos do id selecionado
        int totalItensId = 0;
        
        // cria uma classe para conexão com o banco
        VendasDAO dao = new VendasDAO();
        
        // retorna a quantidade do produto em estoque no bd
        qtdEstoque = dao.verificaEstoque(idProduto);
        
        //carrega uma lista de PRODUTOS com os VALORES da tabela 
        ...
        //soma todos os itens de mesmo id e calcula um total
        for (int i = 0 ; i < (listaProdutos.size()) ; i++){
            // obj recebe um elemento da lista
